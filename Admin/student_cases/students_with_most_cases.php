...
<body>
    ...
    <div class="container">
        <?php 
        // Check if displayMessage function exists before calling it
                    ...
                    <?php else: ?>
                        <?php foreach ($students as $index => $student): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($student['case_count']) ?></td>
                                <td>
                                    <?php if (!empty($student['last_case_date'])): ?>
                                        <?= date('M j, Y', strtotime($student['last_case_date'])) ?>
                                    <?php else: ?>
                                        N/A
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <a href="index.php?student_id=<?= urlencode($student['student_id']) ?>" class="btn">
                                        View All Cases
                                    </a>
                                </td>
                            </tr>
